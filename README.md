...
📍 Кыргызстан
🎓 Студент 3 курса (Программные технологии)

---

## 🧠 Обо мне

Я backend-разработчик, ориентированный на создание реальных проектов с использованием современных технологий.

Работаю с **Java (Spring Boot)** и **Python (FastAPI)**, создаю приложения с базами данных и REST API.
